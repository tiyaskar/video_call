...
function App() {
        ...
        config: {
          iceServers: [
            ...
            // { url: "stun:stun.xten.com" },
            {
              ...
              credential: "daa39a6a-c7bc-11ec-b74a-0242ac140004",
              username: "CakI529btfVr9S6NTh1BXQxt6g9CJbWZLnfoBl5I0mrFfu1qdVfb8GYnk86rjijzAAAAAGJr4kd0aXlhc2thcg",
            },
            // {
  ...
  const audioMute = () => {
    setA(true);
    s.getAudioTracks()[0].enabled = false;
    // a ? setA(false) : setA(true);
    console.log(a);
  };
  const audioOn = () => {
    setA(false);
    s.getAudioTracks()[0].enabled = true;
    // a ? setA(false) : setA(true);
    console.log(a);
  };
  const stopCamera = () => {
